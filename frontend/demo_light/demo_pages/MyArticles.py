...
import frontend.demo_light.utility.db_util as db_util
import streamlit as st
from frontend.demo_light.utility.db_util import DemoFileIOHelper, DemoUIHelper
...
def my_articles_page():
    ...
    if "page2_user_articles_file_path_dict" not in st.session_state:
        local_dir = os.path.join(db_util.get_demo_dir(), "DEMO_WORKING_DIR")
        ...
        with column_to_add:
            ...
            hasClicked = card(
                ...
                image=DemoFileIOHelper.read_image_as_base64(
                    os.path.join(db_util.get_demo_dir(), "assets", "void.jpg")
                ),
