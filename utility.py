...
def get_date_from_openreview(url: str) -> str:
    ...
    if response.status_code == 200:
        ...
        published_element = soup.find(lambda tag: tag.name in ["div", "span"] and "Published:" in tag.get_text())
...
def check_venue_matches(csv_file: str, provided_conference: str, provided_year: int) -> bool:
    ...
    if venue_conference.lower() == provided_conference.lower() and venue_year == provided_year:
...
# provided_conference = "NeuripS"
# provided_year = 2024
# check_venue_matches(csv_file, provided_conference, provided_year)
